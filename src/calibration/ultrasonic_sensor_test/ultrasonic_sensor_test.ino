...
/*
  ...
  Current sensors: front, right, and left HC-SR04.
*/

static const float MAX_DISTANCE_CM = 200.0;
static const uint32_t SONAR_TIMEOUT_US = 12000;

static const uint8_t PIN_TRIG_FRONT = 42;
static const uint8_t PIN_ECHO_FRONT = 43;
static const uint8_t PIN_TRIG_RIGHT = 46;
static const uint8_t PIN_ECHO_RIGHT = 47;
static const uint8_t PIN_TRIG_LEFT = 52;
static const uint8_t PIN_ECHO_LEFT = 53;
...
void setup() {
  ...
  Serial.println("Arduino Mega 3x HC-SR04 ultrasonic sensor test");
}
