...
| Ultrasonic sensor cross-talk or stale readings | Robot may detect openings or exits incorrectly | Medium | Use non-blocking scheduled reads, filtering, and repeated turn tests |
