...
| T08 | Post-turn recovery test | Robot does not immediately chain repeated turns after align and exit recovery |
| T09 | One lap test | Robot completes one lap |
| T10 | Three lap movement test | Robot completes three laps, runs the final straight, actively brakes, and stops |
