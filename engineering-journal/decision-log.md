...
| 2026-07-05 | Return to Arduino Mega 2560 as active controller after urgent hardware constraints | Continue with ESP32, use Arduino Uno | Arduino Mega is available, 5 V logic is compatible with HC-SR04, and it has enough pins for the reduced sensor set | Team confirmed new component list: Mega, L298N, two ultrasonics, MG996R, gyroscope, breadboard, 7.4 V nominal battery, DC motor | Verify physical pin map and upload Mega firmware |
