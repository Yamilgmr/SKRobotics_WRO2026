...
| 2026-07-04 | Use ESP32 Acebott / ESP32 Dev Module as current main controller | Arduino Mega 2560, Raspberry Pi | Matches the current base firmware, supports MPU6050 I2C, and provides PWM for servo and L298N control | Team confirmed physical wiring and ESP32 pin map | Document board settings and collect upload/test evidence |
...
| 2026-07-04 | Use L298N for the first motor-control prototype | Replace with TB6612FNG, BTS7960, ESC, or MOSFET driver | The L298N is available and easy to test with ESP32 PWM, even though it is less efficient | Current prototype photos show the L298N returned to the vehicle | Document wiring, PWM tests, and heat behavior |
